# DrowDetect: Sistem Deteksi Fokus Berbasis Deep Learning secara Real-time
...
**Catatan**: Program ini merupakan proyek akhir dari kelompok Skewer Intelligence dalam program Artificial Intelligence for StartUps 02 yang merupakan program Magang dan Studi Independen Bersertifikat (MSIB) dari Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi.

**Note**: This program is the final project of Skewer Intelligence group in Artificial Intelligence for StartUps 02, which is a Certified Internship and Independent Study Program (MSIB) by the Ministry of Education, Culture, Research, and Technology Republic of Indonesia.
